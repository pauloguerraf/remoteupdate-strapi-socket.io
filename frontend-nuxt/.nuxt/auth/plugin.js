...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_3e2123be($auth, {"endpoints":{"login":{"url":"auth/local","method":"post","propertyName":"jwt"},"logout":false,"user":{"url":"users/me","method":"get","propertyName":false}},"_name":"local"}))
